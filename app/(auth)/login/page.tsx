    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to continue to Collectify</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="h-14 pl-12 pr-12 rounded-xl bg-card border-border text-foreground"
              required
            />
            <button
              type="button"
        ...
        <div className="flex gap-4">
          <Button
            type="button"
            variant="outline"
            className="flex-1 h-14 rounded-xl border-border gap-2"
          >
